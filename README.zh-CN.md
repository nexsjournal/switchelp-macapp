...
| 平台 | 下载 | 安装方式 |
| --- | --- | --- |
| macOS（Apple Silicon） | [下载 DMG](https://github.com/nexsjournal/switchelp-macapp/releases/download/v0.3.2/Switchelp_0.3.2_aarch64.dmg) | 打开 DMG，把 `Switchelp.app` 拖进 Applications |
| Windows（x64） | [下载安装程序](https://github.com/nexsjournal/switchelp-macapp/releases/download/v0.3.2/Switchelp_0.3.2_x64-setup.exe) | 运行 NSIS 安装程序并按提示完成安装 |
